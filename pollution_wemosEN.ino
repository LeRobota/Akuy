/*
 A code to know the pollution datas near your location using a Lolin (ex Wemos) D1 Mini
 and a programmable RGB neopixel LED 
 Inspired by the code "Fabriquer un objet connecté : semaine 3" by Baptiste Gaultier
 
 Created the 07_29_19
 By Arthur Baude
 CC BY 4.0
